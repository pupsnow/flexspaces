package org.integratedsemantics.flexspacesairmobile.view.main
{
    ...
    import org.integratedsemantics.flexspacesairmobile.view.create.html.CreateHtmlView;
    import org.integratedsemantics.flexspacesairmobile.view.create.text.CreateTextView;
    import org.integratedsemantics.flexspacesairmobile.view.create.xml.CreateXmlView;
    import org.integratedsemantics.flexspacesairmobile.view.filebrowse.MobileDownload;
    import org.integratedsemantics.flexspacesmobile.view.main.FlexSpacesMobileViewBase;


    /**
     * Base for FlexSpacesAirMobile overall main view 
     * 
     */
    public class FlexSpacesAirMobileViewBase extends FlexSpacesMobileViewBase
    {
        // local files browser
         ...
         * 
         */
        public function FlexSpacesAirMobileViewBase()
        {
            super();
        }
        ...
        {      
            ...
            // init search view tab ahead of time so since had an issue sometimes that it would not be inited in time when done when first search is done
        ...
        */  
        ...
        protected function createHTML():void
        {
            ...
            else
            {
               ...
               PopUpManager.centerPopUp(createHtmlView);
        ...
        override protected function enableMenusAfterTabChange(tabIndex:int):void
        {
            ...
            if ( (mainMenu != null) && (mainMenu.configurationDone == true) && (toolbar1 != null) )
            {
                ...
                var enablePaste1:Boolean = createChildrenPermission && ((flexSpacesPresModel.cut != null) || (flexSpacesPresModel.copy != null));
                var enablePaste2:Boolean = createChildrenPermission && formatToPaste();
                var enablePaste:Boolean = enablePaste1 || enablePaste2;
        ...
        protected function mobileDownload(): void
        {
            if ( (flexSpacesAirPresModel.selectedItems != null) && (flexSpacesAirPresModel.selectedItems.length > 0) )
            {
                var download:MobileDownload = new MobileDownload();
                download.downloadBrowse(this, flexSpacesAirPresModel.selectedItems);
            }                 
        }
