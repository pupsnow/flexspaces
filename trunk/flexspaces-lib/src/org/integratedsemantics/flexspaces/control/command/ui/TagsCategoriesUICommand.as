package org.integratedsemantics.flexspaces.control.command.ui
{
    ...
    import org.integratedsemantics.flexspaces.view.properties.tagscategories.TagsCategoriesViewBase;
    ...
    public class TagsCategoriesUICommand extends Command
    {
        ...
        public function tagsUI(event:TagsCategoriesUIEvent):void
        {
            ...
            if (selectedItem != null)
            {
                ...
                var tagsCategoriesView:TagsCategoriesViewBase = model.applicationContext.getObject("tagsCategoriesView");
                ...
                PopUpManager.addPopUp(tagsCategoriesView, event.parent); 
                PopUpManager.centerPopUp(tagsCategoriesView);                                            
            }            
        }
