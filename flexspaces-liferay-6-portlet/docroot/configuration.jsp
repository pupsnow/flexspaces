...
{
    String contextName = "flexspaces";
    // flexspaces setup in liferay app server
    flexspacesSwfUrl = HttpUtil.getProtocol(request) + "://" + request.getServerName() + ":" + request.getServerPort() + "/" + contextName + "/";    
    // flexspaces setup in alfresco app server
    //flexspacesSwfUrl = "http://localhost:8080/" + contextName + "/";    
}
