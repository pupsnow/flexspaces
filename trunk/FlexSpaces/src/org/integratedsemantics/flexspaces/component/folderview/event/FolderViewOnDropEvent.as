package org.integratedsemantics.flexspaces.component.folderview.event
{
	...
	public class FolderViewOnDropEvent extends Event
	{
		...
		private var targetfolderlist:FolderViewPresenter;
		 ...
		 * 
		 */
		public function FolderViewOnDropEvent(type:String, action:String, dragSource:DragSource, targetFolderList:FolderViewPresenter)
		{
			super(type);
         ...
         */
        public function get targetFolderList():FolderViewPresenter
        {
