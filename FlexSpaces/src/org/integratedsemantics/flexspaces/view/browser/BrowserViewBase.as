package org.integratedsemantics.flexspaces.view.browser
{
    ...
    /**
     * Base view class for repository browser (no tree, 1 or 2 folder list views, does have version list panel that can be shown/hidden  
     * 
     */
    public class BrowserViewBase extends VDividedBox
    {
         ...
         * Constructor 
         */
        public function BrowserViewBase()
        {
            super();
        }        
        ...
        protected function onChangePathFolderList1(event:FolderViewChangePathEvent):void
        {
            ...
            // fire event to let container know about to new folder path in simple file list browser
            var changePathEvent:RepoBrowserChangePathEvent = new RepoBrowserChangePathEvent(RepoBrowserChangePathEvent.REPO_BROWSER_CHANGE_PATH, event.path);
