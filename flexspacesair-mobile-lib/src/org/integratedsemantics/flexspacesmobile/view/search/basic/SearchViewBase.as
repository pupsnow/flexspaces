package org.integratedsemantics.flexspacesmobile.view.search.basic
{
    ...
    public class SearchViewBase extends HGroup
    {
        ...
        private var sentSearchStarting:Boolean = false;
		...
		{			
            ...
            // don't have keyboard come up on mobile initially
        ...
        {
            searchPresModel.updateSearchText(text);
            
            if (sentSearchStarting == false)
            {
