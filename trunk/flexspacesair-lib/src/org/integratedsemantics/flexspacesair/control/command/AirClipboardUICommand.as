package org.integratedsemantics.flexspacesair.control.command
{
    ...
    public class AirClipboardUICommand extends ClipboardUICommand
    {
        ...
        { 
            ...
            var result:Boolean = transferObject.setData(FlexSpacesPresModel.FLEXSPACES_FORMAT, view, false); 
        ...
        {            
            if (flexSpacesPresModel.currentNodeList is Folder)
            {
                ...
                else if ( (flexSpacesPresModel.cut != null) || (flexSpacesPresModel.copy != null) )
                {
                    super.paste(event);                      
                }
            }          
